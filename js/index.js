...
// Answer options randomized by Brent
...
var Question = function(question_string, correct_choice, wrong_choices) {
  ...
  this.correct_choice_index = Math.floor(Math.random() * (wrong_choices.length + 1)); // Random takes no arguments, returns random number between zero and one
